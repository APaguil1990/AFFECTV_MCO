...
# Load the decision tree model and other components
...
class MyGUI():
    def __init__(self):
        ...
        self.label = tk.Label(self.root, text="Live Text-Emotion Recognition Decision Trees", font=('Helvetica', 20))
        self.label.pack(pady=20)
    ...
    def create_label(self):
        ...
        predicted_class = decision_tree_model.predict(new_vector)  
        predicted_emotion = label_encoder.inverse_transform(predicted_class)  
        ...
        self.newlabel = tk.Label(self.root, text=f"Emotion: {predicted_emotion[0]}", font=('Arial', 30))
        self.newlabel.pack(pady=10)  # Add some padding
